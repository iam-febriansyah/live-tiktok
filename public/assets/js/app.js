!(function () {
  ...
  function v() {
    "vertical" == document.documentElement.getAttribute("data-layout") && ((document.getElementById("two-column-menu").innerHTML = ""), (document.querySelector(".navbar-menu").innerHTML = m), document.getElementById("scrollbar").setAttribute("data-simplebar", ""), document.getElementById("navbar-nav").setAttribute("data-simplebar", ""), document.getElementById("scrollbar").classList.add("h-100")),
  ...
  function E() {
    ...
    e < 1025 && 767 < e
      ? (document.body.classList.remove("twocolumn-panel"),
        "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), f(), L(), h()),
      ...
      : e <= 767 &&
        (document.body.classList.remove("vertical-sidebar-enable"), document.body.classList.add("twocolumn-panel"), "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "vertical"), z("vertical"), h()), "horizontal" != sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "lg"), document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.add("open")),
  ...
  function w(e) {
    if (e.target && e.target.matches("a.nav-link span"))
      ...
      else if (1 == p(e.target.parentElement.nextElementSibling) && 1848 <= window.innerWidth) for (var t = document.getElementsByClassName("dropdown-custom-right"); 0 < t.length; ) t[0].classList.remove("dropdown-custom-right");
    if (e.target && e.target.matches("a.nav-link"))
      ...
      else if (1 == p(e.target.nextElementSibling) && 1848 <= window.innerWidth) for (t = document.getElementsByClassName("dropdown-custom-right"); 0 < t.length; ) t[0].classList.remove("dropdown-custom-right");
  }
  function S() {
    var e = document.documentElement.clientWidth;
  ...
  function I() {
    document.addEventListener("DOMContentLoaded", function () {
      ...
      window.addEventListener("load", function () {
        var e;
        ("twocolumn" == document.documentElement.getAttribute("data-layout") ? L : A)(),
  ...
  function A() {
    ...
    !(e = e.substring(e.lastIndexOf("/") + 1)) ||
      ((e = document.getElementById("navbar-nav").querySelector('[href="' + e + '"]')) &&
        (e.classList.add("active"), (e = e.closest(".collapse.menu-dropdown")) && (e.classList.add("show"), e.parentElement.children[0].classList.add("active"), e.parentElement.children[0].setAttribute("aria-expanded", "true"), e.parentElement.closest(".collapse.menu-dropdown") && (e.parentElement.closest(".collapse").classList.add("show"), e.parentElement.closest(".collapse").previousElementSibling && e.parentElement.closest(".collapse").previousElementSibling.classList.add("active")))));
  }
  function p(e) {
    if (e) {
      var t = e.offsetTop,
      ...
      a == e.value ? (e.checked = !0) : (e.checked = !1),
        e.addEventListener("change", function () {
          document.documentElement.setAttribute(t, e.value),
            ...
            "data-layout" == t && ("vertical" == e.value ? (z("vertical"), h(), feather.replace()) : "horizontal" == e.value ? (z("horizontal"), feather.replace()) : "twocolumn" == e.value && (z("twocolumn"), document.documentElement.setAttribute("data-layout-width", "fluid"), document.getElementById("layout-width-fluid").click(), f(), L(), h(), feather.replace()));
        });
    });
  }
  function F(e, t, a, o) {
    ...
    document.querySelectorAll("[data-toast]").forEach(function (a) {
      a.addEventListener("click", function () {
        ...
        t["data-toast-text"] && (e.text = t["data-toast-text"].value.toString()),
          ...
          Toastify({ newWindow: !0, text: e.text, gravity: e.gravity, position: e.position, className: "bg-" + e.className, stopOnFocus: !0, offset: { x: e.offset ? 50 : 0, y: e.offset ? 10 : 0 }, duration: e.duration, close: "close" == e.close, style: "style" == e.style ? { background: "linear-gradient(to right, #0AB39C, #405189)" } : "" }).showToast();
      });
    }),
